...
function Universities() {
  ...
  return (
    <div>
      <PageHeader title="Университеты" subtitle="Все вузы мира с фильтрами, программы и требования. Добавь 3–5 вузов в цели — под них строится карта развития." />
